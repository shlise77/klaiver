		...
		<div id="paper">
			...
			<div id="company_profile">
				...
				<div id="follow_num_home1">
					...
					<p id="edit">
						<a
							href="update_contact?cid=${k_contactVO.cid}&userid=${sessionScope.login}">편집</a>
					</p>
				</div>
			...
			<div id="contents_wrap">
				<table>
					...
					<tr>
						...
						<td class="data"><span id="corporate_form">${k_contactVO.fax}</span></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="data"><c:forEach items="${group}" var="group">
								<c:if test="${sessionScope.login == group.userid}">
									<a href="../member/individual?keyword=${group.userid}"
										style="color: black; text-decoration: none;"><span
										id="business_type">${group.first}${group.last}(${group.title})</span></a>
									<br>
								</c:if>
								<c:if test="${sessionScope.login != group.userid}">
									<a href="../member/individualfollow?email=${group.userid}"
										style="color: black; text-decoration: none;"><span
										id="business_type">${group.first}${group.last}(${group.title})</span></a>
									<br>
								</c:if>
